...
/**
 * Modale d'édition d'une entrée de temps. Permet de modifier date, heures,
 * projet, commentaire ; et de supprimer l'entrée.
 */
export function EditEntryDialog({
  ...
  // Pré-remplit quand on ouvre une nouvelle entrée
  useEffect(() => {
    if (!entry) return
    setDate(entry.date)
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-lg font-semibold text-zinc-900 mb-1">{"Modifier l'entrée"}</h3>
